...
public class SpinnerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (container instanceof FrameLayout) {
            progressBar.getIndeterminateDrawable().setColorFilter(container.getContext().getResources().getColor(R.color.colorPrimary), android.graphics.PorterDuff.Mode.MULTIPLY);
