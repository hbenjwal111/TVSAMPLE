...
/**
 * Helper class to store {@link Subscription}s and {@link PlaybackModel}s in {@link SharedPreferences}.
 *
...
public final class SharedPreferencesHelper {
     ...
     */
    public static List<PlaybackModel> readMovies(Context context, long channelId) {
        return getList(context, PlaybackModel.class, PREFS_SUBSCRIBED_MOVIES_PREFIX + channelId);
    }
     ...
     */
    public static void storeMovies(Context context, long channelId, List<PlaybackModel> movies) {
